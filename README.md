...
Durante meu período de estágio na Eficiência Hospitalista, tenho desenvolvido alguns dashboards com o Google Data Studio para acompanhamento das unidades e apresentação de indicadores. Na imagem, um dashboard construído para o Escritório de Gestão de Altas de um hospital público do ES.
